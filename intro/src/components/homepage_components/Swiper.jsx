                            ...
                            <section className='text-left w-full my-2'>
                                <div className='flex items-center my-2'>
                                    <div className='flex items-center'>
                                        ...
                                        <p className="font-normal text-md ml-2 text-blue dark:text-gray-400">Universidad</p>
                                    </div>

                                </div>

                                <p className="font-medium text-lg text-blue my-2 dark:text-gray-400">Investigación I</p>

                                <p className="font-light text-sm text-blue my-2 dark:text-gray-400">Desarrollo de Aplicaciones Interactivas</p>

                                <p className="font-light text-sm text-blue my-2 dark:text-gray-400">Oct 30</p>
